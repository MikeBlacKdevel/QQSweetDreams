  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="text-center">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4">Apuestas Abiertas</h1>
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 card-glow">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="text-sm font-semibold text-yellow-800 mb-1">🎯 Auto-predicción</div>
            <div className="text-xs text-yellow-600">Ganar: +20 pts | Perder: -10 pts</div>
          </div>
        </div>
      </div>
      ...
      <div className="text-center">
        <button
          onClick={onOpenBet}
          className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 btn-glow"
          disabled={isPending}
        >
          🔥 Apostar
        </button>
      ...
      {bets.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 card-glow">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 text-center">Apuestas Activas</h3>
              ...
              >
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400 truncate">{bet.predicted_winner}</span>
                    {bet.status !== "pending" && (
                      <span
